...
"""
Random Sample of Coffee Sales Data
date	time	cash_type	card	price	coffee_name	quarter	month	year
2025-03-06	12:37	card	ANON-0000-0000-1158	3.576	Cappuccino	1	3	2025
"""
...
"""
"""
Chart chart_v1.png is displayed.
"""
...
The bars are grouped by year on the x-axis instead of coffee names, making the axis label misleading. The legend is confusing, no gridlines reduce readability, and x-labels overlap. Transposing the data so coffee names are on the x-axis, unstacking years, adding gridlines, rotating labels, and adjusting the legend improves clarity.
"""
...
# Group by coffee_name and year, then sum the prices
sales_summary = q1_sales.groupby(['coffee_name', 'year'])['price'].sum().unstack(fill_value=0)

# Plotting
fig, ax = plt.subplots(figsize=(10, 6))
colors = ['#1f77b4', '#ff7f0e']
sales_summary.plot(kind='bar', ax=ax, color=colors, edgecolor='black')
...
"""
"""
Chart chart_v2.png is displayed.
"""
...
"""
- Tried initial code generation with different models:
    - original: gpt-4o-mini
    - change 1: gpt-4.1-mini - the same result, minor variations in the code, different labelling
    - change 2: gpt-3.5-turbo - code does not run
- Tried different reasoning model:
    - original o4-mini
    - change 1: gpt-4.1 - exactly the same result
    - change 2: claude-3-7-sonnet-latest - connection refused
"""
...
# In[11]:
"""
List files in Jupyter server working directory
import os
...
# In[12]:
"""
Create Jupyter link to a specific file
from IPython.display import FileLink
FileLink('coffee_sales.csv') # provide a link to data file
"""
